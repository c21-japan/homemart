...
export default async function PropertiesNewPage() {
  ...
  const filteredItems = items.filter((item) => (item.property_type || '') === '新築戸建')
    ...
    <div className="min-h-screen bg-[#FFF6DE]/60">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-xs uppercase tracking-[0.35em] text-[#8C7A4C]">NEW HOMES</p>
            <h1 className="text-3xl font-display text-[#15130D]">新築戸建</h1>
