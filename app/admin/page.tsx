  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const submitData = {
        ...
        land_area_tsubo: parseFloat(formData.land_area_tsubo) || null,
            ...
            {formData.property_type === '土地' && (
              <div className="border-t pt-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">引渡し条件</label>
                    <select
