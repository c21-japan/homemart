-- ホームマート権限管理システム - 新規Supabaseプロジェクト用セットアップ
-- 実行日時: $(date)
...
-- システム管理
('system.admin', 'システム管理', 'システム全体の管理', 'system'),
('user.manage', 'ユーザー管理', 'ユーザーの作成・編集・削除', 'system'),
('user.read', 'ユーザー閲覧', 'ユーザー情報の閲覧', 'system'),
('user.update', 'ユーザー編集', 'ユーザー情報の編集', 'system'),

-- 物件管理
('property.create', '物件作成', '新規物件の作成', 'property'),
...
('inui@homemart.co.jp', '$2b$12$0YGnxJsBgRiMArU6ejL1DOCqKGHCcxWwvbQGiEmArULXHBSJ9XEr2', 'owner');
...
-- 完了メッセージ
-- ========================================
SELECT '🎉 ホームマート権限管理システムのデータベーススキーマが完了しました！' as message;
